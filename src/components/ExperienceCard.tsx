...
export function ExperienceCard({ experience }: ExperienceCardProps) {
  ...
  return (
    <motion.div
      className="bg-gray-900 rounded-lg shadow-lg overflow-hidden cursor-pointer border border-gray-800"
    ...
    >
      ...
      >
        <motion.div className="p-6" layout>
          <motion.h4 className="font-semibold mb-2 text-purple-400" layout>Technologies:</motion.h4>
